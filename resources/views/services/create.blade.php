...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="col-md-6">
        <div class="card p-4 shadow-lg border-0">
            <h3 class="text-center fw-bold mb-4 text-info">Cadastrar Novo Serviço</h3>
            ...
            <form action="{{ route('services.store') }}" method="POST" novalidate>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('valor') is-invalid @enderror" 
                               type="number" step="0.01" name="valor" value="{{ old('valor') }}" 
                     ...
                     <div class="col-md-6 mb-3">
                        ...
                        <input class="form-control @error('categoria') is-invalid @enderror" 
                               type="text" name="categoria" value="{{ old('categoria') }}" 
                ...
                <button class="btn btn-primary w-100 fw-bold">Cadastrar Serviço</button>
            </form>
