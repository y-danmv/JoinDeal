...
<head>
    ...
    <style>
        /* Seu CSS (igual ao que você enviou) */
        body {
            color: #ffffff;
            min-height: 100vh;
        }
        ...
        .card {
            ...
            color: #ffffff;
            border-radius: 1rem;
            border: none; /* Removido border-0 e adicionado border:none */
        }
        ...
        .form-control:focus, .form-select:focus { /* Adicionado .form-select */
            border-color: #7C3AED;
            box-shadow: 0 0 0 0.2rem rgba(124, 58, 237, 0.25);
            background-color: #334155; /* Garante fundo no focus */
            color: #ffffff; /* Garante texto no focus */
        }
        .form-select option { /* Estilo para options */
             background-color: #334155;
             color: #ffffff;
        }
        ...
        .alert-error-custom, .alert-danger { /* Adicionado .alert-danger */
            background-color: #F87171 !important; /* Corrigido para vermelho */
            color: #FFFFFF !important;
            border: 1px solid #334155 !important; 
            font-weight: bold;
        }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('services.index') ? 'active' : '' }}" href="{{ route('services.index') }}">Serviços</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('orders.index') ? 'active' : '' }}" href="{{ route('orders.index') }}">Minhas Contratações</a>
                    </li>

                    @if (Auth::user()->tipo == 'Prestador')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('services.create') ? 'active' : '' }}" href="{{ route('services.create') }}">Anunciar Serviço</a>
                    </li>
                    @endif
